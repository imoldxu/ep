...
public class JSONUtils {
	 ...
	 */
	public static <T> T getObjectByJson(String jsonStr, Class<T> _class) throws JsonParseException, JsonMappingException, IOException {
		T t = mapper.readValue(jsonStr, _class);
		return t;
	}
	...
	public static <T> List<T> getObjectListByJson(String jsonStr,
			Class<T> _class) throws JsonParseException, JsonMappingException, IOException {
		JavaType javaType = mapper.getTypeFactory().constructParametricType(
				ArrayList.class, _class);
		List<T> tList = mapper.readValue(jsonStr, javaType);
		return tList;
	}
	...
	public static <T> Map<String, T> getObjectMapByJson(String jsonStr,
		...
		Map<String, T> tMap = mapper.readValue(jsonStr, javaType);
		return tMap;
	}
