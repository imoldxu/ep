...
public class DateUtils {
    ...
    public static java.util.Date addSecounds(Date paramDate, int paramInt)
        ...
        localCalendar.set(Calendar.SECOND, i + paramInt);
        return localCalendar.getTime();
    }
    
    public static java.util.Date reduceDays(Date paramDate, int paramInt)
    {
        Calendar localCalendar = Calendar.getInstance();
        localCalendar.setTime(paramDate);
        localCalendar.add(Calendar.DATE, 0-paramInt);
//        int i = localCalendar.get(6);
//        if(i - paramInt > 0){
//        	localCalendar.set(6, i - paramInt);
//        }else{
...
//        }
	...
	public static int getSecondsBetween(Date begin, Date end) {
		...
		long betweenTime = end.getTime() - begin.getTime();
		int ret = (int)(betweenTime / 1000);
		return ret;
	}
