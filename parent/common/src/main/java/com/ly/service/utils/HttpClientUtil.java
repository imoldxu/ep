...
public class HttpClientUtil {
     ...
     * @throws IOException
     */
    public int postJson(String jsonObj) throws IOException {
        //httpMethod.setRequestHeader("Connection", "close");
...
//    	  try {
//			h.open("http://file.api.weixin.qq.com/cgi-bin/media/get?access_token="+SignUtil.gettoken()+"&media_id="+media_id, "get");
//			  h.setRequestHeader("Cookie", "Language=zh_CN;UserAgent=PC");
//			   int status = h.send();
